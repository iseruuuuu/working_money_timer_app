...
abstract class L10n {
  ...
  /// No description provided for @timerSetAppBar.
  ///
  /// In ja, this message translates to:
  /// **'秒給タイマー'**
  String get timerSetAppBar;

  /// No description provided for @timerSetWorkTime.
  ///
  /// In ja, this message translates to:
  /// **'設定時間'**
  String get timerSetWorkTime;

  /// No description provided for @timerSetWorkPrice.
  ///
  /// In ja, this message translates to:
  /// **'時給'**
  String get timerSetWorkPrice;

  /// No description provided for @timerSetStart.
  ///
  /// In ja, this message translates to:
  /// **'スタート'**
